...
|-------------------------------------|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| `BLOCKSEMBLER_SERVER_NAME`          | `localhost`        | The server name used by the nginx configuration.                                                                                                         |
...
| `BLOCKSEMBLER_BACKEND_API_URL`      | `http://localhost` | Base URL of the backend API.                                                                                                                             |
...
| `BLOCKSEMBLER_RESOURCE_LINKS`       | `[]`               | A list of additional resource links displayed in the Blocksembler navigation. Each item of this list needs must provide the properties `name` and `url`. |
