...
import {InsperHackEmulator} from "@/architectures/insperHack/system";

//dec %A
test("Test 1: dec instruction to machine code (dec %A)", () => {
...
test("Test 4: increment register A", () => {
    ...
    let emulator = new InsperHackEmulator();
    emulator.registers = {
        'pc': pcWord,
        '%A': regAWord,
        '%D': regDWord,
...
//dec %D
test("Test 1: dec instruction to machine code (dec %D)", () => {
