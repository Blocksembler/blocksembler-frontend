...
import {ArmletInstructionFactory, StoInstruction} from "@/architectures/armlet/instructions.js";
...
test("test execute sto instruction", () => {
    ...
    mockSystem.memory[4].set(Word.fromSignedIntValue(24))

    let expectedSystemState = generateMockSystem([0, 13, 17, 5, 4, 1, 7, 7, 1], instruction)
    mockSystem.memory[4].set(Word.fromSignedIntValue(5))
