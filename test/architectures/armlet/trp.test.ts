...
import {ArmletInstructionFactory, TrpInstruction} from "@/architectures/armlet/instructions";
...
test("test execute trp instruction", () => {
    ...
    mockSystem.interruptHandler['alert'] = (_e: BaseEmulator, msg: string): string | null => {
        console.log(msg)
        return null;
    };
